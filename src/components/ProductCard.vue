...
<template>
  ...
  >
    ...
    <a href="#" class="mt-4 text-sm text-[#333]">{{ productInfo.category }}</a>

    <div
      class="flex flex-col justify-between w-full items-start absolute -bottom-2 transition-all duration-300 group-hover:bottom-6"
    >
      <span
