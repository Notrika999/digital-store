...
<template>
  <div class="flex items-center justify-between pr-5 xl:pr-16 pl-5 bg-[#e6effd]">
    <div class=" pr-3 flex-1">
      <ul class="flex items-center gap-x-2 py-4">
        <button @click="isMobileCategoryOpen = !isMobileCategoryOpen" class="xl:hidden inline-block">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="#00f" d="M4 7q-.425 0-.712-.288T3 6t.288-.712T4 5h16q.425 0 .713.288T21 6t-.288.713T20 7zm0 12q-.425 0-.712-.288T3 18t.288-.712T4 17h16q.425 0 .713.288T21 18t-.288.713T20 19zm0-6q-.425 0-.712-.288T3 12t.288-.712T4 11h16q.425 0 .713.288T21 12t-.288.713T20 13z"/></svg>
        </button>
